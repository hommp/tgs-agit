...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            <img class="masthead-avatar mb-5 w-100 rounded" src="{{ Storage::url($jumbotron->thumbnail) }}"
                alt="{{ $jumbotron->title }}" />
    ...
    <section class="page-section portfolio" id="partner">
        <div class="container">
            ...
            <div ```blade <div class="divider-custom">
                <div class="divider-custom-line"></div>
                <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                <div class="divider-custom-line"></div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ $i }}">
                        ...
                        <img class="img-fluid" src="{{ Storage::url($item->thumbnail) }}" alt="{{ $item->title }}" />
                    </div>
                </div>
                @php
                $i++;
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 ms-auto text-center">
                    <img src="{{ Storage::url($about->thumbnail) }}" class="w-75" alt="{{ $about->title }}" />
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    @endif
                    @if ($x)
                    <a class="btn btn-outline-light btn-social mx-1" href="{{ $x }}"><i
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg ```blade
                            <div class=" col-lg-8">
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">{{ $item->title }}
                                </h2>
